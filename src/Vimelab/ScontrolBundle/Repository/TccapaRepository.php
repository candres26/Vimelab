...
class TccapaRepository extends EntityRepository
{
    public function getCount()
    {
        $em = $this->getEntityManager();
        $querry = $em->createQuery("SELECT COUNT(o) FROM ScontrolBundle:Tccapa o");
    ...
    {
        $em = $this->getEntityManager();
        $querry = $em->createQuery("SELECT m FROM ScontrolBundle:Tccapa m WHERE m.nombre LIKE '%$parametro%' or m.codigo LIKE '%$parametro%' ORDER BY m.id ASC");
        return $querry->getResult();
    }
}
