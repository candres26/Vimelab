...
class CttariRepository extends EntityRepository
{
    public function getCount()
    {
        $em = $this->getEntityManager();
        $querry = $em->createQuery("SELECT COUNT(o) FROM ScontrolBundle:Cttari o");
    ...
    {
        $em = $this->getEntityManager();
        $querry = $em->createQuery("SELECT m FROM ScontrolBundle:Cttari m JOIN m.ctserv l WHERE m.id LIKE '%$parametro%' or l.nombre LIKE '%$parametro%' ORDER BY m.id ASC");
        return $querry->getResult();
    }
}
