...
class CtservRepository extends EntityRepository
{
    public function getCount()
    {
        $em = $this->getEntityManager();
        $querry = $em->createQuery("SELECT COUNT(o) FROM ScontrolBundle:Ctserv o");
    ...
    public function getPage($limite = 20, $pagina = 1)
    {
        ...
        $em = $this->getEntityManager();
        $querry = $em->createQuery("SELECT o FROM ScontrolBundle:Ctserv o");
    ...
    {
        $em = $this->getEntityManager();
        $querry = $em->createQuery("SELECT m FROM ScontrolBundle:Ctserv m WHERE m.codigo LIKE '%$parametro%' or m.nombre LIKE '%$parametro%' or m.tipo LIKE '%$parametro%' ORDER BY m.id ASC");
        return $querry->getResult();
    }
}
