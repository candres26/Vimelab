...
class HspersRepository extends EntityRepository
{
    public function getCount()
    {
        $em = $this->getEntityManager();
        $querry = $em->createQuery("SELECT COUNT(o) FROM ScontrolBundle:Hspers o");
    ...
    {
        $em = $this->getEntityManager();
        $querry = $em->createQuery("SELECT m , l FROM ScontrolBundle:Hspers m JOIN m.mdpaci l WHERE l.identificacion LIKE '%$parametro%' ORDER BY m.id ASC");
        return $querry->getResult();
    }
}
