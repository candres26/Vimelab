...
class GbpaisRepository extends EntityRepository
{
    public function getCount()
    {
        $em = $this->getEntityManager();
        $querry = $em->createQuery("SELECT COUNT(o) FROM ScontrolBundle:Gbpais o");
    ...
    {
        $em = $this->getEntityManager();
        $querry = $em->createQuery("SELECT m FROM ScontrolBundle:Gbpais m WHERE m.nombre LIKE '%$parametro%' or m.codigo LIKE '%$parametro%' ORDER BY m.id ASC");
        return $querry->getResult();
    }
}
