...
class DefaultController extends Controller
{
	...
	{	
		...
		List example:
		<ol>
		    <li><img src="bundles/scontrol/imagenes/logo_example.png" alt="test alt attribute" width="30" height="30" border="0" /> test image</li>
		    <li><b>bold text</b></li>
		...
		<img src="bundles/scontrol/imagenes/logo_example.png" alt="test alt attribute" width="100" height="100" border="0" /><img src="bundles/scontrol/imagenes/tiger.ai" alt="test alt attribute" width="100" height="100" border="0" /><img src="bundles/scontrol/imagenes/logo_example.jpg" alt="test alt attribute" width="100" height="100" border="0" />
		</div>';
		...
		<tr><td><img src="bundles/scontrol/imagenes/logo_example.png" border="0" height="41" width="41" /></td></tr>
		<tr style="text-align:left;"><td><img src="bundles/scontrol/imagenes/logo_example.png" border="0" height="41" width="41" align="top" /></td></tr>
		<tr style="text-align:center;"><td><img src="bundles/scontrol/imagenes/logo_example.png" border="0" height="41" width="41" align="middle" /></td></tr>
		<tr style="text-align:right;"><td><img src="bundles/scontrol/imagenes/logo_example.png" border="0" height="41" width="41" align="bottom" /></td></tr>
		<tr><td style="text-align:left;"><img src="bundles/scontrol/imagenes/logo_example.png" border="0" height="41" width="41" align="top" /></td></tr>
		<tr><td style="text-align:center;"><img src="bundles/scontrol/imagenes/logo_example.png" border="0" height="41" width="41" align="middle" /></td></tr>
		<tr><td style="text-align:right;"><img src="bundles/scontrol/imagenes/logo_example.png" border="0" height="41" width="41" align="bottom" /></td></tr>
		</table>';
		...
		require($pdf->getDir().'/htmlcolors.php');
...
EOF;
		...
		<ul style="font-size:14pt;list-style-type:img|png|4|4|bundles/scontrol/imagenes/logo_example.png">
		...
		if(Tool::isGrant($this))
		{
			...
			if($request->isXmlHttpRequest())
			{
				...
				foreach($entities as $caso)
					$res[] = array($caso->getId(), $caso->getIdentificacion(), $caso->getFullName());
