...
class GbsucuController extends Controller
{
    ...
    public function indexAction($pag)
    {
		if(Tool::isGrant($this))
		{
			...
			$pages = $em->getRepository('ScontrolBundle:Gbsucu')->getCountPages(20);
			$pag = $pag < 1 ? 1 : $pag;
			$pag = $pag > $pages ? $pages: $pag;
			
			$entities = $em->getRepository('ScontrolBundle:Gbsucu')->getPage(20, $pag);
	...
	public function filterAction($param = '')
    {
        ...
        return $this->render("ScontrolBundle:Gbsucu:index.html.twig", array('entities' => $entities, 'pages' => 1, 'pag' => 1));
    }
